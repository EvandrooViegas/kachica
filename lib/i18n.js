    ...
    caseStudiesData: [
      {
        ...
        link: "https://www.barberph.online/",
        src: "/case_studies/ph.jpg",
        featured: false,
        gallery: [
          "/case_studies/gallery/ph/1.png",
          "/case_studies/gallery/ph/2.png",
          "/case_studies/gallery/ph/3.png",
        ],
      },
      {
        id: 1,
        ...
        link: "https://www.prumosoalheiro.site/",
        src: "/case_studies/prumo.jpg",
        featured: true,
        gallery: [
          "/case_studies/gallery/prumo/1.png",
          "/case_studies/gallery/prumo/2.png",
          "/case_studies/gallery/prumo/3.png",
        ],
      },
      {
        id: 2,
        ...
        featured: false,
    gallery: [
          "/case_studies/gallery/sonia/1.png",
          "/case_studies/gallery/sonia/2.png",
          "/case_studies/gallery/sonia/3.png",
        ],
      },
